...
const skillGroups = [
  {
    label: "FRONT-END",
    items: ["React.js", "JavaScript", "Angular", "React Native", "HTML / CSS"],
  },
  {
    label: "BACK-END",
    items: ["C# / .NET", "ASP.NET Core", "Java", "Python / Flask", "REST APIs"],
  },
  { label: "DATA", items: ["MS SQL Server", "MySQL", "Stored Procedures"] },
  { label: "SECURITY", items: ["JWT / OAuth", "RBAC", "API Security"] },
  {
    label: "CLOUD / OPS",
    items: ["AWS (EC2, S3)", "Docker", "Jenkins CI/CD", "Git"],
  },
];
...
const education = [
  {
    deg: "BSc Honours — Computer Science",
    org: "Tshwane University of Technology",
    dates: "2026 — Present",
  },
  {
    deg: "Advanced Diploma — Computer Science",
    org: "Tshwane University of Technology",
    dates: "2025",
  },
  {
    deg: "National Diploma — Computer Science",
    org: "Tshwane University of Technology",
    dates: "2023",
  },
];
    ...
    >
      ...
      >
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          <button
            ...
            className="disp font-semibold text-lg tracking-tight"
            style={{ color: INK }}
          >
            D. EBULA
          </button>
      ...
      <section id="about" className="relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 pt-20 pb-16 relative">
          ...
          <h1
            className="disp font-semibold leading-[1.05] mb-6"
            style={{ fontSize: "clamp(2.2rem, 5vw, 3.6rem)" }}
          >
            Building systems that
            <br />
            people trust with <span style={{ color: COPPER }}>React.</span>
          </h1>
          <p
            className="max-w-xl mb-8 leading-relaxed"
            style={{ color: INK_SOFT, fontSize: 17 }}
          >
            Full-stack software developer with 3+ years of experience shipping
            React front-ends, secure APIs, and data-driven platforms. Currently
            completing a BSc Honours in Computer Science, and looking for a
            React-focused internship or graduate role to keep building.
          </p>
          <div className="flex flex-wrap gap-3 mb-16">
            <button
              onClick={() => scrollTo("projects")}
              className="disp inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium"
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {skillGroups.map((g) => (
            <div
              key={g.label}
              className="p-5"
              style={{ background: CARD, border: `1px solid ${PAPER_LINE}` }}
            >
              <div
                className="mb-3"
                style={{
          ...
          >
            ...
            <div className="disp text-sm" style={{ color: INK }}>
              English — Fluent
            </div>
            <div className="disp text-sm" style={{ color: INK }}>
              French — Native
      ...
      <section id="experience" className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div
          ...
          style={{ borderLeft: `1px solid ${PAPER_LINE}` }}
        >
          {experience.map((e, i) => (
            <div key={i} className="mb-10 relative">
              ...
              <div className="flex flex-wrap items-baseline gap-x-3 mb-1">
                ...
                <span style={{ color: TEAL, fontWeight: 600, fontSize: 14 }}>
                  {e.org}
                </span>
              </div>
              <div
              ...
              <ul className="space-y-1.5">
                {e.points.map((p, j) => (
                  ...
                  >
                    <ChevronRight
                      size={14}
                      style={{ marginTop: 3, flexShrink: 0, color: COPPER }}
                    />
                    {p}
                  </li>
                ))}
      ...
      <section id="education" className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-5 mb-6">
          {education.map((ed, i) => (
            ...
            >
              ...
              <div className="disp font-semibold mb-1" style={{ fontSize: 15 }}>
                {ed.deg}
              </div>
        ...
        <div
          className="p-5 inline-flex items-center gap-3"
          style={{ border: `1px dashed ${PAPER_LINE}` }}
        >
          <span
            style={{
          ...
          <span className="text-sm" style={{ color: INK }}>
            Cisco CCNA — Networking Fundamentals (Introductory Level)
          </span>
        </div>
      </section>
      ...
      >
        <div className="max-w-5xl mx-auto px-6 py-20 relative">
          ...
          <h2
            className="disp font-semibold leading-tight mb-8"
            style={{ fontSize: "clamp(1.8rem, 4vw, 2.8rem)", color: PAPER }}
          >
            Open to React internships
            <br />
            and graduate roles.
          </h2>
          <div className="flex flex-col gap-4 mb-10">
            <a
              ...
              className="inline-flex items-center gap-3 text-sm w-fit"
              style={{ color: "#D8E4E9" }}
            >
              <Mail size={16} style={{ color: COPPER }} />{" "}
            ...
            <div
              ...
              style={{ color: "#D8E4E9" }}
            >
              <MapPin size={16} style={{ color: COPPER }} /> Pretoria, Gauteng,
              South Africa
            </div>
          </div>
          <div className="flex gap-4">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium disp"
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium disp"
              style={{ border: "1px solid #3C5A6B", color: PAPER }}
            >
